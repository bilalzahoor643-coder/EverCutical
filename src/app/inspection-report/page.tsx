    ...
    <>
      ...
      <main className="relative">
        ...
        <section ref={hero.ref} className="relative min-h-[100svh] flex items-center justify-center bg-transparent overflow-hidden">
          ...
          <div className="max-w-5xl mx-auto px-4 sm:px-6 text-center z-10 text-glow-strong">
            ...
            <p className="text-white/60 text-xs sm:text-sm md:text-base max-w-2xl mx-auto leading-relaxed mb-6 sm:mb-10 px-2"
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-3 sm:gap-4"
              ...
              <a href="#certificates" className="inline-flex items-center px-6 sm:px-8 py-3 sm:py-3.5 rounded-full bg-[#0ea5e9] text-white text-xs sm:text-sm font-semibold hover:bg-[#0284c7] transition-all duration-300 shadow-[0_4px_20px_rgba(14,165,233,0.25)] hover:shadow-[0_8px_30px_rgba(14,165,233,0.35)]">
                View Certificates
              ...
              <a href="#results" className="inline-flex items-center px-6 sm:px-8 py-3 sm:py-3.5 rounded-full border border-white/[0.15] text-white/80 text-xs sm:text-sm font-semibold hover:border-[#0ea5e9]/30 hover:text-[#38bdf8] transition-all duration-300">
                See Results
              </a>
            </div>
          </div>
          ...
          <div className="absolute bottom-6 sm:bottom-10 left-1/2 -translate-x-1/2 flex flex-col items-center gap-2"
            ...
            <span className="text-[9px] sm:text-[10px] text-white/50 tracking-widest uppercase">Scroll</span>
            <div className="w-4 sm:w-5 h-7 sm:h-8 border-2 border-white/20 rounded-full flex justify-center pt-1.5">
              <div className="w-1 h-1.5 sm:h-2 bg-white/40 rounded-full animate-[scrollBounce_1.5s_infinite]" />
            </div>
          </div>
        </section>
          ...
          <div className="w-full max-w-6xl mx-auto px-4 sm:px-6 z-10">
            <div className="grid grid-cols-2 md:grid-cols-4 gap-3 sm:gap-4">
              {inspectionReport.trustStats.map((stat, i) => (
                <div key={i} className="glass-card relative rounded-xl sm:rounded-2xl p-4 sm:p-6 text-center shadow-[0_4px_20px_rgba(0,0,0,0.04)] overflow-hidden group hover:shadow-[0_8px_30px_rgba(14,165,233,0.08)] transition-all duration-500"
                  style={{
                  ...
                  <div className="text-[9px] sm:text-[11px] text-white/50 font-medium tracking-wide uppercase">{stat.label}</div>
        ...
        <section ref={certificates.ref} id="certificates" className="relative bg-transparent py-16 sm:py-24 overflow-hidden">
          ...
          <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 z-10 relative text-glow">
            <div className="text-center mb-10 sm:mb-16"
              ...
              <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold text-white mt-4 sm:mt-5 mb-3 sm:mb-4 leading-tight">
                KTR <span className="text-[#38bdf8]">Certificates</span>
              </h2>
              <p className="text-white/60 text-xs sm:text-sm md:text-base max-w-xl mx-auto leading-relaxed px-2">
        ...
        <section ref={results.ref} id="results" className="relative bg-transparent py-16 sm:py-24 overflow-hidden">
          ...
          <div className="w-full max-w-6xl mx-auto px-4 sm:px-6 z-10 text-glow">
        ...
        <section ref={cta.ref} className="relative bg-transparent py-16 sm:py-24 overflow-hidden">
          ...
          <div className="w-full max-w-4xl mx-auto px-4 sm:px-6 z-10 relative text-glow">
            <div style={{ opacity: cta.visible ? 1 : 0, transform: `translateY(${cta.visible ? 0 : 60}px) scale(${cta.visible ? 1 : 0.9})`, transition: "opacity 1.5s cubic-bezier(0.22,1,0.36,1), transform 1.5s cubic-bezier(0.22,1,0.36,1)" }}>
              <div className="glass-card relative rounded-2xl p-6 sm:p-10 md:p-14 text-center shadow-[0_8px_40px_rgba(0,0,0,0.06)] overflow-hidden">
                ...
                <p className="text-white/60 text-xs sm:text-sm md:text-base max-w-lg mx-auto leading-relaxed mb-6 sm:mb-8 px-2"
                ...
                <div className="flex flex-col sm:flex-row items-center justify-center gap-3 sm:gap-4"
                  ...
                  <Link href="/#products" className="inline-flex items-center gap-2 bg-[#0ea5e9] text-white text-xs sm:text-sm font-semibold px-6 sm:px-8 py-3 sm:py-3.5 rounded-full hover:bg-[#0284c7] transition-all duration-300 shadow-[0_4px_20px_rgba(14,165,233,0.25)] hover:shadow-[0_8px_30px_rgba(14,165,233,0.35)]">
                    View Products
                    <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17 8l4 4m0 0l-4 4m4-4H3" /></svg>
                  </Link>
                  <Link href="/research-technology" className="inline-flex items-center gap-2 border border-white/[0.15] text-white/80 text-xs sm:text-sm font-semibold px-6 sm:px-8 py-3 sm:py-3.5 rounded-full hover:border-[#0ea5e9]/30 hover:text-[#38bdf8] transition-all duration-300">
                    Research &amp; Technology
                  </Link>
                </div>
              </div>
  ...
  return (
    <div
      ...
      <div className="relative h-[220px] sm:h-[280px] md:h-[320px] lg:h-[360px] overflow-hidden">
        ...
        <div className="absolute bottom-3 right-3 sm:bottom-4 sm:right-4 transition-all duration-400" style={{ opacity: hovered ? 1 : 0, transform: `scale(${hovered ? 1 : 0.5})` }}>
          <div className="w-8 h-8 sm:w-10 sm:h-10 rounded-full bg-white/90 backdrop-blur-sm flex items-center justify-center shadow-lg">
            <svg className="w-4 h-4 sm:w-5 sm:h-5 text-[#0c1929]" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0zM10 7v3m0 0v3m0-3h3m-3 0H7" /></svg>
          </div>
        </div>
      </div>
      ...
      <div className="relative p-4 sm:p-6">
        ...
        <h3 className="text-base sm:text-lg font-bold text-white mb-1.5 sm:mb-2">{cert.title}</h3>
        <p className="text-[12px] sm:text-[13px] text-white/60 leading-relaxed">{cert.description}</p>
        ...
        <div className="flex items-start gap-3 sm:gap-4">
          ...
          <div className="flex-1 min-w-0">
            <div className="flex flex-wrap items-center gap-2 sm:gap-3 mb-1.5 sm:mb-2">
              <h4 className="text-[14px] sm:text-[15px] md:text-[16px] font-bold text-white">{item.title}</h4>
            ...
            <p className="text-[12px] sm:text-[13px] text-white/60 leading-[1.6] sm:leading-[1.7]">{item.desc}</p>
          </div>
        </div>
