    ...
    return (
      <main className="min-h-screen flex items-center justify-center">
        ...
        <div className="text-center px-6">
          <h1 className="text-3xl md:text-4xl font-bold text-white mb-4">Product Not Found</h1>
        ...
        <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 z-10" ref={hero.ref}>
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
            <div style={{ opacity: hero.visible ? 1 : 0, transform: hero.visible ? "translateX(0)" : "translateX(-60px)", transition: "opacity 1.3s cubic-bezier(0.22,1,0.36,1) 0.2s, transform 1.3s cubic-bezier(0.22,1,0.36,1) 0.2s" }}>
              ...
              <p className="text-white/60 text-sm md:text-[15px] leading-relaxed mb-8 max-w-xl">{product.desc}</p>
              <div className="flex flex-col sm:flex-row items-start gap-4">
                <Link href="/contact" className="inline-flex items-center px-6 md:px-8 py-3.5 rounded-full text-white text-sm font-semibold transition-all duration-300 shadow-lg hover:shadow-xl" style={{ backgroundColor: accent, boxShadow: `0 4px 20px ${accent}40` }}>
                  Get Started
                ...
                <a href="#kit-contents" className="inline-flex items-center px-6 md:px-8 py-3.5 rounded-full border border-white/[0.08] text-white/80 text-sm font-semibold hover:border-white/[0.15] transition-all duration-300">
                  View Details
                </a>
              </div>
            </div>
            ...
            <div className="flex justify-center lg:justify-end" style={{ opacity: hero.visible ? 1 : 0, transform: hero.visible ? "translateX(0) scale(1)" : "translateX(60px) scale(0.9)", transition: "opacity 1.4s cubic-bezier(0.22,1,0.36,1) 0.3s, transform 1.4s cubic-bezier(0.22,1,0.36,1) 0.3s" }}>
              <div ref={productImageRef} className="relative w-[280px] h-[280px] md:w-[360px] md:h-[360px] lg:w-[420px] lg:h-[420px] rounded-3xl overflow-hidden" style={{ boxShadow: `0 20px 80px ${accent}25, 0 0 120px ${accent}10`, animation: hero.visible ? "gentleFloat 6s ease-in-out infinite" : "none" }}>
      ...
      <section id="kit-contents" className="relative bg-transparent py-10 md:py-16 overflow-hidden scroll-mt-20">
        ...
        <div className="w-full max-w-7xl mx-auto px-5 sm:px-6 z-10">
          <div ref={kitContents.ref} className="text-center mb-8" style={{ opacity: kitContents.visible ? 1 : 0, transform: `translateY(${kitContents.visible ? 0 : 50}px)`, transition: "opacity 1.3s cubic-bezier(0.22,1,0.36,1), transform 1.3s cubic-bezier(0.22,1,0.36,1)" }}>
            ...
            <p className="text-white/60 text-sm md:text-base max-w-xl mx-auto leading-relaxed">Every kit contains precision-formulated components for optimal regenerative results.</p>
          </div>
      ...
      <section className="relative bg-transparent py-10 md:py-16 overflow-hidden">
        ...
        <div className="w-full max-w-7xl mx-auto px-5 sm:px-6 z-10">
          <div ref={peptidesSection.ref} className="text-center mb-8" style={{ opacity: peptidesSection.visible ? 1 : 0, transform: `translateY(${peptidesSection.visible ? 0 : 50}px)`, transition: "opacity 1.3s cubic-bezier(0.22,1,0.36,1), transform 1.3s cubic-bezier(0.22,1,0.36,1)" }}>
            ...
            <p className="text-white/60 text-sm md:text-base max-w-xl mx-auto leading-relaxed">{product.peptides.length} bioactive peptides work synergistically to deliver targeted regenerative signals.</p>
          </div>
        ...
        <section className="relative bg-transparent py-10 md:py-16 overflow-hidden">
          ...
          <div className="w-full max-w-7xl mx-auto px-5 sm:px-6 z-10 relative">
            <div ref={caseStudies.ref} className="text-center mb-8" style={{ opacity: caseStudies.visible ? 1 : 0, transform: `translateY(${caseStudies.visible ? 0 : 50}px)`, transition: "opacity 1.3s cubic-bezier(0.22,1,0.36,1), transform 1.3s cubic-bezier(0.22,1,0.36,1)" }}>
              ...
              <p className="text-white/60 text-sm md:text-base max-w-xl mx-auto leading-relaxed">Documented clinical outcomes from real patients.</p>
            </div>
              ...
              {product.caseStudies.map((cs, i) => (
                ...
                >
                  ...
                  <div className="mt-6 max-w-2xl mx-auto text-center px-4">
                    <h4 className="text-lg font-bold text-white mb-1">{cs.name}</h4>
                    <p className="text-xs text-white/50 mb-2">{cs.gender}, Age {cs.age} — {cs.concern}</p>
                    <p className="text-sm text-white/60 mb-3">{cs.results}</p>
                    <div className="relative pl-3 border-l-2 inline-block text-left" style={{ borderColor: `${accent}30` }}>
                      <p className="text-sm text-white/60 italic">&ldquo;{cs.feedback}&rdquo;</p>
                    </div>
            ...
            <div className="glass-card p-6 md:p-8 overflow-hidden">
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-white/60 leading-relaxed">{product.importantNote}</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="w-full max-w-4xl mx-auto px-5 sm:px-6 z-10 relative">
          <div ref={bottomCta.ref} style={{ opacity: bottomCta.visible ? 1 : 0, transform: `translateY(${bottomCta.visible ? 0 : 60}px) scale(${bottomCta.visible ? 1 : 0.9})`, transition: "opacity 1.5s cubic-bezier(0.22,1,0.36,1), transform 1.5s cubic-bezier(0.22,1,0.36,1)" }}>
            <div className="glass-surface p-6 sm:p-8 md:p-10 lg:p-14 text-center overflow-hidden">
              ...
              <h2 className="text-2xl md:text-3xl lg:text-4xl font-bold text-white mb-2 leading-tight">Ready to Get <span style={{ color: accent }}>Started</span>?</h2>
              <p className="text-white/60 text-sm md:text-base max-w-lg mx-auto leading-relaxed mb-5">Contact us to learn more or place an order.</p>
              <div className="flex flex-col sm:flex-row items-center justify-center gap-3">
                <Link href="/contact" className="inline-flex items-center gap-2 text-white text-sm font-semibold px-6 md:px-8 py-3.5 rounded-full transition-all duration-300 shadow-lg hover:shadow-xl" style={{ backgroundColor: accent, boxShadow: `0 4px 20px ${accent}40` }}>
                  Contact Us
                  <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17 8l4 4m0 0l-4 4m4-4H3" /></svg>
                </Link>
                <Link href="/products" className="inline-flex items-center gap-2 border border-white/[0.08] text-white/80 text-sm font-semibold px-6 md:px-8 py-3.5 rounded-full hover:border-white/[0.15] transition-all duration-300">
                  Back to Products
                </Link>
              </div>
            </div>
    ...
    <div className="group relative rounded-2xl overflow-hidden cursor-default glass-card" onMouseEnter={() => setHovered(true)} onMouseLeave={() => setHovered(false)} style={{
      ...
      <div className="p-5 sm:p-6">
        <div className="flex items-start gap-4">
          ...
          <div>
            <h4 className="text-sm font-bold text-white mb-1">Vial {index + 1}</h4>
      ...
      <div className="p-5">
        <div className="flex items-start gap-3">
          ...
          <div className="min-w-0">
            <h4 className="text-[13px] font-bold text-white mb-1 leading-snug">{peptide.name}</h4>
            <p className="text-[11px] sm:text-[12px] text-white/50 leading-relaxed">{peptide.function}</p>
          </div>
        </div>
      </div>
    </div>
    ...
    <div className="group relative rounded-xl overflow-hidden glass-card" onMouseEnter={() => setHovered(true)} onMouseLeave={() => setHovered(false)} style={{
      ...
      <div className="p-5 sm:p-6">
        <div className="flex items-start gap-4">
          ...
          <p className="text-[13px] text-white/80 leading-relaxed font-medium">{benefit}</p>
        </div>
      </div>
    </div>
  )
    ...
    <div className="group relative rounded-xl overflow-hidden glass-card" onMouseEnter={() => setHovered(true)} onMouseLeave={() => setHovered(false)} style={{
      ...
      <div className="p-5 sm:p-6">
        <div className="flex items-center gap-4">
          ...
          <p className="text-[14px] text-white/80 leading-relaxed font-medium">{item}</p>
        </div>
      </div>
    </div>
  )
      ...
      <div className="p-5 sm:p-6">
        <div className="flex items-start gap-4">
          ...
          <div>
            ...
            <p className="text-[14px] text-white/80 leading-relaxed">{step}</p>
          </div>
        </div>
      </div>
    </div>
